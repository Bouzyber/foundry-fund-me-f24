#Este archivo es para abreviar los scripts tan largos que se usan en la terminal 
-include .env
...
build:; forge build
deploy-sepolia:
	script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(URL_SEPOLIA) --private-key $(PRIVATE_KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv